...
def gerar_posicao_aleatoria() -> tuple:
  ...
  x = random.uniform(ESPACO_VIRT_LARG/16, ESPACO_VIRT_LARG/4)
  y = random.uniform(ESPACO_VIRT_ALT/8, ESPACO_VIRT_ALT/2)
...
def criar_estrelas(quant_estrelas: int) -> list:
  ...
  # Criando a estrela central
  x = (ESPACO_VIRT_LARG / 2)
  y = (ESPACO_VIRT_ALT / 2)
